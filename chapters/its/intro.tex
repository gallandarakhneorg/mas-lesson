...
\begin{frame}{Goals of this Lecture}
	During this lecture, I will :
	\begin{enumerate}
	\item remind you Intelligent Transport Systems
	\vspace{.5em}
	\item present the concepts of agent and multiagent systems
	\vspace{.5em}
	\item detail the principles and advantages of the agent-based simulation
	\end{enumerate}
\end{frame}
