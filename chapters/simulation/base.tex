	...
	\begin{columns}
		\begin{column}[t]{.2\linewidth}
			\begin{bottomarrowsequence}
				...
				\only<1-2>{\arrow{Event-based}}
				\only<3>{\arrow[bg=CIADgreen]{Event-based Time}}
		...
		\begin{column}[t]{.8\linewidth}
			\only<1>{
				...
				\end{block}
				\centering\includegraphics[width=.8\linewidth]{time_continuous}
			}
			\only<2>{
				\smaller
				\begin{block}{Principle}
				...
				\begin{block}{Mathematical Model}
					...
					where $\mathbf{x}\!\in\!\mathbb{R}^n$ is the state vector, $\mathbf{u}\!\in\!\mathbb{R}^m$ the input, and $\mathbf{y}\!\in\!\mathbb{R}^p$ the output
				\end{block}
				\centering\includegraphics[width=.8\linewidth]{time_discrete_constant}
			}
			\only<3>{
				\smaller
				\begin{block}{Principle}
				...
				\begin{block}{Mathematical Model}
					...
					\end{compactdescription}
				\end{block}
				\centering\includegraphics[width=.8\linewidth]{time_event_based}
      			}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}[t]{{Multilevel Model:} coupled models or dynamic model}
	\begin{columns}
		\begin{column}{.5\linewidth}
			\centering\includegraphics[height=.9\textheight]{multilevel_coupling}
		\end{column}
		\begin{column}{.5\linewidth}
			\centering\includegraphics[height=.9\textheight]{multilevel_dynamic}
		\end{column}
	\end{columns}
\end{frame}
