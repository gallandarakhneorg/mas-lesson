...
\begin{frame}{What is the Agent Environment?} 
	\begin{definitionblock}{Agent Environment \cite{Weyns.07}}
...
\sidenote{Mix of the archectures given by \cite{Weyns.07,Weyns05,Viroli07}}
\animatedfigureslide{Environment Layers}{environment_layers} 
