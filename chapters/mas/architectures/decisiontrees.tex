...
\begin{frame}[t]{Pathological Decision Trees}
	Problem to be solved: \Emph{Avoiding multiple instances of the same action} \\
...
\begin{frame}[t]{{Unrealistic} Random Decision}
	\begin{alertblock}{Problem of Decision Trees}
		If decision trees are \emph{run frequently}, i.e., reacting to the immediate state of the world, then random decisions cause problems
	\end{alertblock}	
	\begin{example}
		\begin{center}
